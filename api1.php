...
require_once 'BookingCalendar1.php'; // Include your BookingCalendar class
  ...
  switch ($action) {
    ...
    case 'add_booking':
      ...
      try {
        ...
        $message = "Dear <b>$name</b>,<br><br>Your <b>Body Wash Only</b> booking at <b>Station-01</b> for <b>$vehicleModel</b>(<b>$vehicleNumber</b>) on <b>$date</b> at <b>$timeslot</b> has been confirmed!<br><br>Thank you for choosing Autocare Lanka.<br><br>WE LOVE YOUR VEHICLE SAME AS YOU DO!";
