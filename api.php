...
require_once 'BookingCalendar.php'; // Include your BookingCalendar class
  ...
  switch ($action) {
    ...
    case 'add_booking':
      ...
      try {
        ...
        $message = "Dear <b>$name</b>,<br><br>Your <b>Full Service</b> booking on <b>Station-04</b> for <b>$vehicleModel</b>(<b>$vehicleNumber</b>) on <b>$date</b> at <b>$timeslot</b> has been confirmed!<br><br>Thank you for choosing Autocare Lanka.<br><br>WE LOVE YOUR VEHICLE SAME AS YOU DO!";
